...
async function renderPage(env) {
    ...
    console.log("post kv", String(postKVList));
    console.log("project kv", String(projectKVList));
    ...
    console.log("post keys", String(postKeys));
    console.log("project keys", String(projectKeys));
